...
module.exports.run = async ({ args, api, event, Currencies, client }) => {
  ...
  if (args[0] == "checkpoint") {// kick người dùng fb
    ...
    var world = jsondata.world,
      ...
      pthoiphuctg = Math.round((hoiphuctg * 100) / nhiemtg),nodemodule
